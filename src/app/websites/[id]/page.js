...
export default function WebsiteDetail() {
  ...
  const fetchWebsiteData = async () => {
    ...
    try {
      // Get website details
      const { data: websiteData, error: websiteError } = await getWebsiteById(
        id
      );
      ...
      // Get traffic data
      const { data: trafficRes, error: trafficError } =
        await getTrafficByWebsite(id, timeRange);
      if (trafficError) throw trafficError;

      // Get source distribution
      const { data: sourceData, error: sourceError } = await getTrafficBySource(
        id,
        timeRange
      );
      ...
      setTrafficData({
        ...
        bySource: sourceData || [],
        recentVisits: trafficRes
          ? trafficRes.slice(0, 10).map((item) => ({
              source: item.source,
              page: item.page_path,
                      ...
                      <dd className="mt-1 text-sm text-gray-900">
                        <div className="relative bg-gray-50 p-4 rounded-md border border-gray-200">
                          <div className="font-mono text-sm overflow-x-auto whitespace-nowrap">
                            {`<script src="https://www.parsleyanalytics.com/ai-traffic-tracker.js" data-website-id="${website.id}"></script>`}
                          </div>
                        ...
                        <div className="mt-4">
                          <details className="group">
                            <summary className="flex items-center text-sm font-medium text-supabase-green cursor-pointer hover:text-supabase-green/80">
                              <svg
                            ...
                            <div className="mt-3 pl-7 text-sm text-gray-700">
                              ...
                              <ol className="list-decimal pl-5 space-y-2">
                                <li>
                                  Add the script to your layout.js/layout.tsx
  ...
  return (
    <html lang="en">
      ...
      <body>{children}</body>
                                ...
                                <li>
                                  Update your next.config.js to configure CORS
                                  for the tracker:
                                  <pre className="mt-2 bg-gray-100 p-2 rounded-md overflow-x-auto text-xs">
        ...
        headers: [
          {
            ...
            value: 'https://www.parsleyanalytics.com',
          },
        ],
      },
    ];
...
module.exports = nextConfig;`}
                                ...
                                <li>
                                  Redeploy your application for the changes to
                                  take effect.
                                </li>
                              </ol>
...
<body>
  <!-- your content -->
                                ...
                                <li>
                                  ...
                                  this to your policy:
                                  <pre className="mt-2 bg-gray-100 p-2 rounded-md overflow-x-auto text-xs">
                                    {`Content-Security-Policy: script-src 'self' https://www.parsleyanalytics.com;`}
                                  </pre>
                                </li>
                              </ol>

                              <p className="mt-4 text-xs text-gray-500">
                                Note: The tracker works by detecting AI
                                platforms that visit your site. No additional
                                configuration is needed beyond adding the
                                script.
                              </p>
                            </div>
                          </details>
                ...
                <div className="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
                  <div className="px-4 py-5 sm:p-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Once AI platforms start citing your website, traffic data
                      will appear here.
                    </p>
                    <p className="mt-5 text-sm font-medium text-gray-700">
                      Make sure you've added the tracking code to your website's
                      &lt;head&gt; section.
                    </p>
                    <div className="mt-4 flex justify-center space-x-4">
                      <a
                        href="#tracking-code"
                        className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200"
                      >
                        View Tracking Code
                      </a>
                    </div>
            ...
            <div className="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
              <div className="px-4 py-5 sm:p-6 text-center">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  The website you are looking for does not exist or you don't
